;(function(window) {
	...
	function fetch(url, options) {
		...
		if (options !== undefined) opts = { ...fetchOptions, ...options }
	...
	function xhr(url, method, headers, type) {
	...
	class Instagram {
		...
		remove(id) {
			...
			return xhr(`${WEB_API}${this.action}s/${id}/un${this.action}/`, 'POST', headers)
		}
		...
		add(id) {
			...
			return xhr(`${WEB_API}${this.action}s/${id}/${this.action}/`, 'POST', headers)
		}
	}
