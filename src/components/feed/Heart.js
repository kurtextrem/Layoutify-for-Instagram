...
const Heart = props =>
	props.active ? (
		<svg aria-label="Unlike" fill="#ed4956" height={props.size} viewBox="0 0 48 48" width={props.size}>
			<path
				clipRule="evenodd"
		...
		<svg aria-label="Like" width={props.width} height={props.size} fill={props.fill} viewBox="0 0 48 48">
			<path
				clipRule="evenodd"
