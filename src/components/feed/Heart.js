...
const Heart = props =>
	props.active ? (
		<svg aria-label="Gefällt mir nicht mehr" fill="#ed4956" height={props.height} viewBox="0 0 48 48" width={props.width}>
			<path
				clipRule="evenodd"
		...
		<svg aria-label="Gefällt mir" width={props.width} height={props.height} fill={props.fill} viewBox="0 0 48 48">
			<path
				clipRule="evenodd"
