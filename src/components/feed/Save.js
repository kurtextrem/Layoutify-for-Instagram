...
const Save = props =>
	props.active ? (
		<svg aria-label="Entfernen" fill="#262626" height={props.height} viewBox="0 0 48 48" width={props.width}>
		...
		<svg aria-label="Speichern" fill="#262626" height={props.height} viewBox="0 0 48 48" width={props.width}>
