	...
	render() {
		return (
			<div>
				<h3>About</h3>
				<p>
					Improved Layout for Instagram does not store any data of your
					Instagram account apart from on your PC. The Code is Open Source on{' '}
					<a
				...
				<p>
					...
					or mail me:{' '}
					<a href="mailto:kurtextrem@gmail.com">kurtextrem@gmail.com</a>.
				</p>
				<p>
				...
				<p>
					Follow me on <a href="https://instagram.com/jacobgross_">Instagram</a>{' '}
					or <a href="https://twitter.com/kurtextrem">Twitter</a> for updates!
				</p>
				...
				<p>
					...
					<br />
					And to all the bug reporters that have sent me mails. I always try my
